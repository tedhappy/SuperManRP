package why.superman.redpacket.service;
...
import why.superman.redpacket.utils.HongbaoSignature;
import why.superman.redpacket.utils.LogUtils;
import why.superman.redpacket.utils.PowerUtil;
...
public class HongbaoService extends AccessibilityService implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private void playSound() {
        boolean pref_sound = sharedPreferences.getBoolean("pref_sound", true);
        MediaPlayer player = MediaPlayer.create(this,R.raw.coming);
